...
<div class="container" style="margin-top:25px">
 <form method="post" action="ins_fin_det1.php" >    
...
$sqll="SELECT location FROM main_image WHERE flag1='1'";
$result = $conn->query($sqll);
$row = $result->fetch_assoc();
$s=$row["location"];
if($s==="anantapur" or $s==="singanamala" or $s==="guntakal" or $s==="uravakonda"  or $s==="rayadurg"  or $s==="tadipatri"  or $s==="kalyanadurg")
	$s="anantapur";
else if($s==="kurnool" or $s==="pattikonda" or $s==="kodumur")
	$s="Kurnool";
else if($s==="hindupur" or $s==="raptadu" or $s==="madakasira" or $s==="penukonda"  or $s==="puttaparthi"  or $s==="dharmavaram"  or $s==="kadiri")
	$s="hindupur";
else if($s==="nellore" or $s==="kandukur" or $s==="kavali" or $s==="atmakur"  or $s==="kovuru")
	$s="nellore";
$query_salutation_type = "SELECT username,password,location FROM cand_mp WHERE location='$s'";
